...
<div class="container-fluid contact py-5">
    <div class="container py-5">
        <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 800px;">
            <h1 class="display-5 text-capitalize text-primary mb-3">Get In Touch</h1>
            <p class="mb-0">We're here to assist you. Whether you have questions, feedback, or need help with our
                services, feel free to reach out. Fill out the form below, and we'll get back to you as soon as
                possible.</p>
        </div>
        <div class="row g-5">
                ...
                <div class="row g-5">
                    <div class="col-md-6 col-lg-6 col-xl-3">
                        <div class="contact-add-item p-4">
                            ...
                            <div>
                                ...
                                <p class="mb-0">123 Main Street, Downtown, USA</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="contact-add-item p-4">
                            ...
                            <div>
                                <h4>Email Us</h4>
                                <p class="mb-0">support@yourwebsite.com</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-secondary p-5 rounded">
                    ...
                    <form>
                        <div class="row g-4">
                            ...
                            <div class="col-lg-12 col-xl-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" id="service" placeholder="Service Needed">
                ...
                <div class="p-5 bg-light rounded">
                    ...
                    <div class="bg-white rounded p-4 mb-4">
                        ...
                        <div class="d-flex align-items-center mb-3">
                            <p class="mb-0 text-dark me-2">Address:</p><i
                                class="fas fa-map-marker-alt text-primary me-2"></i>
                            <p class="mb-0">456 Market Street, Suburb, USA</p>
                        </div>
                        <div class="d-flex align-items-center">
                            <p class="mb-0 text-dark me-2">Telephone:</p><i
                                class="fa fa-phone-alt text-primary me-2"></i>
                            <p class="mb-0">(+123) 987 6543</p>
                        </div>
                    </div>
                    <div class="bg-white rounded p-4 mb-0">
                        <h4 class="mb-3">Support Center</h4>
                        <div class="d-flex align-items-center mb-3">
                            <p class="mb-0 text-dark me-2">Address:</p><i
                                class="fas fa-map-marker-alt text-primary me-2"></i>
                            <p class="mb-0">789 Tech Park, City, USA</p>
                        </div>
                        <div class="d-flex align-items-center">
                            <p class="mb-0 text-dark me-2">Telephone:</p><i
                                class="fa fa-phone-alt text-primary me-2"></i>
                            <p class="mb-0">(+123) 123 4567</p>
                        </div>
                    </div>
                </div>
            </div>
